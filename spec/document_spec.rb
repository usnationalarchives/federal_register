...
describe FederalRegister::Document do
  ...
  describe ".find_all" do
    ...
    it "handles results when no documents are returned" do
      FakeWeb.register_uri(
        :get,
        "https://www.federalregister.gov/api/v1/documents/bad_document_number,.json?fields[]=document_number&fields[]=title",
        :content_type =>"text/json",
    ...
    it "appends a trailing comma when a single document is provided to ensure API interface doesn't return a single document" do
      FakeWeb.register_uri(
        :get,
        "https://www.federalregister.gov/api/v1/documents/2016-26522,.json?fields[]=document_number&fields[]=title",
        :content_type =>"text/json",
